# MSX Disk Manager Utility - Versão 1.8
...
- **Versão 1.8 (Esta Versão)**: Uma **reescrita completa do zero em PureBasic**. Consolida todas as funções de leitura e escrita em uma única biblioteca e em um único utilitário unificado de console, eliminando a dependência do compilador C e de DLLs de terceiros (como `msys-2.0.dll`).
